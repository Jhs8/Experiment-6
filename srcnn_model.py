...
class SRCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = default_conv(in_channels=1, out_channels=64, kernel_size=9, padding=4, bias=False, init_scale=0.1)
        self.conv2 = default_conv(in_channels=64, out_channels=32, kernel_size=1, padding=0, bias=False, init_scale=0.1)
        self.conv3 = default_conv(in_channels=32, out_channels=1, kernel_size=5, padding=2, bias=False, init_scale=0.1)
